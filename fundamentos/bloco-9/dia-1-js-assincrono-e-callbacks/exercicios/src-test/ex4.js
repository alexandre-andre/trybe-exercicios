...
const sendMarsTemperature = () => { 
  ...
  setTimeout(() => { // o setTimeout eh responsavel por executar uma acao dps de x tempo
    console.log(`Mars temperature is: ${current} degree Celsius`) // acao
  }, messageDelay()) // tempo para a acao ser executada
};
